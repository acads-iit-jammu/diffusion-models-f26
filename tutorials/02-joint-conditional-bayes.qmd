...
[the rigorous account](./10-transport-rigorous.qmd)) study what *additional*
...
Likelihood](./04-distributions-mle.qmd), and the score in
[Two-Point Diffusion](./07-two-point-diffusion.qmd) and
[the probability-flow ODE](./09-probability-flow-ode.qmd). KL has no
